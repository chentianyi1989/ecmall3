...
class OrderController extends Controller
{
    ...
    public function pay()
    {
        $rules = [
            'order'   => 'required|integer|min:1',
            'code'    => 'required|string|in:alipay.app,wxpay.app,unionpay.app,cod.app,wxpay.web,teegon.wap,alipay.wap,wxpay.wxa',            
            'openid'  => 'required_if:code,wxpay.web|string',
            'channel' => 'string',
            'referer' => 'string',
            'shop'    => 'required_if:code,teegon.wap|integer',
        ];
        ...
        $payarr = ['alipay.app' => 'pay.alipay', 'wxpay.app' => 'pay.weixin', 'unionpay.app' => 'pay.unionpay', 'cod.app' => 'pay.cod','wxpay.web' => 'pay.wxweb','teegon.wap' => 'pay.teegon','alipay.wap' => 'pay.alipaywap','wxpay.wxa'=>'pay.wxa'];
