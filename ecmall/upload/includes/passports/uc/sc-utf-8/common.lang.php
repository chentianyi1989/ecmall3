...
'toseller_store_closed_notify' => '您的店铺已被关闭，原因是：{$reason}',
    ...
    'code_example' => "字体加粗：[b]加粗[/b]<br />图片标签：[img]http://ecmall.shopex.cn/images/logo.gif[/img]<br/>超链接标签：[url=http://yunqi.shopex.cn/products/ecmall]ECMall官方网站[/url]<br/>引用标签：[quote]ECMall[/quote]<br />代码标签：[code]array('2222','3333')[/code]",
);
?>
