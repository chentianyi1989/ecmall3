...
/* 平台统一收款单状态 */
define('PROCEEDS_SUCC', 20);                  // 支付成功
define('PROCEEDS_FAIL', 0);                   // 支付失败
...
define('YUNQI_SERVICE_URL','http://fw.yunqi.shopex.cn/iframe?');/* 云起服务地址 */

/* openapi相关 */
define('OPENAPI_KEY', '4k65yhsy');
define('OPENAPI_SECRET', '4y2ij6nsjolse7vn2ibi');
define('OPENAPI_SITE', 'https://openapi.shopex.cn');
define('OPENAPI_OAUTH', 'https://openapi.shopex.cn/oauth');
define('OAUTH_API_PATH', 'api');
/* auth的产品code */
define('PRODUCT_CODE', 'product_0757');

/* 云起发送短信 */
define('SOURCE_ID', '369548');
define('SOURCE_TOKEN', 'd2ab0095617b8a3498636561d0131b62');
/* 云起发送短信 */

/* ishopex的 key secret site*/
define('OPENAPI_IKEY', '2bq7skb4');
define('OPENAPI_ISECRET', 'ledd25ocs6jhbxz4lmns');
define('OPENAPI_ISITE', 'https://openapi.ishopex.cn');
...
class ECBaseApp extends BaseApp
{
    ...
    function _init_session()
    {
        ...
        {
            $this->_session = new SessionProcessor(db(), '`'.DB_PREFIX.'sessions`', '`'.DB_PREFIX.'sessions_data`', 'ECM_ID');
            /* 清理超时的购物车项目 */
            $this->_session->add_related_table('`'.DB_PREFIX.'cart`', 'cart', 'session_id', 'user_id=0');
        }
...
EOT;
    ...
    function _assign_query_info()
    {
        ...
        /*  是否去版权  */
        if (defined('NO_COPYRIGHT')) {
            $this->assign('ecm_no_copyright_time', NO_COPYRIGHT);
        }
