...
<div class="eject_con">
    <div class="info_table_wrap">
        ...
        <ul class="info_table">
            ...
            <li>
                <h4>默认物流公司:</h4>
                <select name="corp_id" id="corp_id"><option value="">请选择...</option>
                <?php echo $this->html_options(array('options'=>$this->_var['dlycorps'],'selected'=>$this->_var['shipping']['corp_id'])); ?></select>
            </li>
            <li>
                <h4>首件邮费:</h4>
