<?php echo $this->fetch('search.header.html'); ?>
...
?>
                        <a href="javascript:;" id="<?php echo $this->_var['filter']['key']; ?>"><b><?php echo $this->_var['filter']['name']; ?>：</b><?php echo $this->_var['filter']['value']; ?><span class="js-del"></span></a>
                        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                        <?php else: ?>
                        <strong>按条件筛选</strong>
                        <?php endif; ?>
...
if ($this->_foreach['fe_row']['total'] > 0):
    foreach ($_from AS $this->_var['row']):
        $this->_foreach['fe_row']['iteration']++;
?>
                                <a href="javascript:void(0);" title="<?php echo $this->_var['row']['min']; ?> - <?php echo $this->_var['row']['max']; ?>" <?php if ($this->_foreach['fe_row']['iteration'] >= 25): ?>class="toggle" style="display:none"<?php endif; ?>><?php echo price_format($this->_var['row']['min']); ?> - <?php echo price_format($this->_var['row']['max']); ?><span class="count">(<?php echo $this->_var['row']['count']; ?>)</span></a>
                                <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                            </ul>
                        </div>
                        <?php endif; ?>
...
?>
                            ...
                            <ul class="attr-list clearfix <?php if ($this->_foreach['fe_gcategory']['iteration'] >= 25): ?> toggle hidden<?php endif; ?>" ectype="ul_category">
                                <?php endif; ?>
                                <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                            </ul>
                        </div>
...
?>
                            <dl class="item clearfix dl-<?php echo $this->_var['goods']['goods_id']; ?>" <?php if (! ($this->_foreach['fe_goods']['iteration'] <= 1) && $this->_foreach['fe_goods']['iteration'] % 5 == '0'): ?>style="margin-right:0"<?php endif; ?>>
...
?>
                                ...
                                <dd class="status clearfix">
                                    <span>已售<em><?php echo ($this->_var['goods']['sales'] == '') ? '0' : $this->_var['goods']['sales']; ?> 件</em></span>
                                    <span>评论<a href="<?php echo url('app=goods&act=comments&id=' . $this->_var['goods']['goods_id']. ''); ?>"><?php echo ($this->_var['goods']['comments'] == '') ? '0' : $this->_var['goods']['comments']; ?></a></span>
