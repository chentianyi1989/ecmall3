...
<div class="content">
  ...
  <div id="right">
        ...
        <div class="wrap">
            <div class="eject_btn_two eject_pos1" title="淘宝助理导入" style="top: 20px;"><b class="ico1" onclick="go('index.php?app=my_goods&amp;act=import_taobao');">淘宝助理导入</b></div>
...
?>
                    ...
                    <?php endforeach; else: ?>
                    <tr>
                        <td class="align2 member_no_records padding6" colspan="11"><?php echo $this->_var['lang'][$_GET['act']]; ?>没有符合条件的商品</td>
                    </tr>
