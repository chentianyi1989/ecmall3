        		...
        		<form method="post" id="login_form">
              		...
              		<dl class="clearfix">
               		...
               		<dl class="clearfix">
                  		...
                  		<dd class="clearfix">
                     		...
                     		忘记密码？
                        <a href="<?php echo url('app=find_password'); ?>" class="clew">通过邮箱</a>
                        <a href="<?php echo url('app=find_password&act=sms_find_password'); ?>" class="clew">通过短信</a>
                	...
                	<dl class="clearfix">
                  		...
                  		<dd class="register-now">
                        	如果您还不是会员，请注册<a href="<?php echo url('app=member&act=register&ret_url=' . $this->_var['ret_url']. ''); ?>" title="注册">注册</a>
                        </dd>
               		</dl>
