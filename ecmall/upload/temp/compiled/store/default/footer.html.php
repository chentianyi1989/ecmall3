...
?>
    ...
    <?php if (! $this->_var['ecm_no_copyright_time']): ?>
    Powered by <a href="http://yunqi.shopex.cn/products/ecmall" target="_blank">ECMall <?php echo $this->_var['ecm_version']; ?></a> &copy; 2003-2017 <a href="http://www.shopex.cn" target="_blank">ShopEx Inc.</a>
    <?php endif; ?>
</div>
