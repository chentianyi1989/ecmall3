...
class CashierApp extends ShoppingbaseApp
{
    ...
    function index()
    {
        ...
        if ((!$order_info['payment_id'] && $order_info['payment_code'] != 'yunqi') || ($order_info['payment_code'] == 'yunqi' && !$_GET['yunqi_paymethod']))
        {
        ...
        else
        {
            ...
            if ($_GET['yunqi_paymethod']) {
                $order_info['yunqi_paymethod'] = $_GET['yunqi_paymethod'];
            }
    ...
    function goto_pay()
    {
        ...
        #可能不合适
        if ($order_info['payment_id'] && $order_info['payment_code'] != 'yunqi')
        {
        ...
        if ($payment_info['payment_code'] == 'yunqi') {
            $yunqi_paymethod = $_POST['yunqi_paymethod'];
            if (!$yunqi_paymethod) {
                $this->show_warning('no_such_data');
                return;
            }
            $this->_goto_pay($order_id . '&yunqi_paymethod=' . $yunqi_paymethod);
            return;
        }
