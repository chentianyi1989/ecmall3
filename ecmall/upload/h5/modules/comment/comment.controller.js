(function () {
  ...
  CommentController.$inject = ['$scope', '$http', '$window', '$timeout', '$location', '$state', '$stateParams', 'API', 'ENUM' , 'ConfigModel'];

  function CommentController($scope, $http, $window, $timeout, $location, $state, $stateParams, API, ENUM , ConfigModel) {
