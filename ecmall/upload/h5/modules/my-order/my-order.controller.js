(function () {
	...
	MyOrderController.$inject = ['$scope', '$http', '$window', '$timeout', '$location', '$state', '$stateParams', 'API', 'ENUM', 'PaymentModel', 'MyOrderModel', 'OrderExpressModel','ConfigModel'];

	function MyOrderController($scope, $http, $window, $timeout, $location, $state, $stateParams, API, ENUM, PaymentModel, MyOrderModel, OrderExpressModel,ConfigModel) {
    ...
    $scope.isShippingEnable = ConfigModel.getFeature()['logistics'];
