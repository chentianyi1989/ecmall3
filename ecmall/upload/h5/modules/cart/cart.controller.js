(function () {
	...
	CartController.$inject = ['$scope', '$http', '$location', '$state', 'ConfirmCartService', 'CartModel', 'ConfigModel'];

	function CartController($scope, $http, $location, $state, ConfirmCartService, CartModel, ConfigModel) {
		...
		$scope.touchSelectShop = _touchSelectShop;
		$scope.isSelected = _isSelected;
		$scope.isSelectedShop = _isSelectedShop;
		...
		function _touchSubmit() {
			...
			ConfirmCartService.shop = $scope.selectedShop;
		...
		function _touchSelectShop(target) {
			var groups = $scope.cartModel.groups;
			...
			$scope.selectedGoods = target.goods;
			$scope.selectedShop = target.shop;
		...
		function _isSelectedShop(group) {
			var selectedGoods = $scope.selectedGoods;
